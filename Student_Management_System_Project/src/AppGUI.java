...
public class AppGUI extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            String sql = "INSERT INTO student_db VALUES('" + studentIdField.getText() + "', '"
            ...
            // Display all student_db in database
            ...
            // Sort student_db by selected column
            ...
            String sql = "";
            switch (choice) {
                case 0 -> sql = "SELECT * FROM student_db ORDER BY first_name";
                case 1 -> sql = "SELECT * FROM student_db ORDER BY last_name";
                case 2 -> sql = "SELECT * FROM student_db ORDER BY major";
                default -> {
                }
            }
            try {
            ...
            String sql = "SELECT * FROM student_db WHERE " + column + " LIKE '%" + searchTerm + "%'";
            ...
            String sql = "SELECT * FROM student_db WHERE student_id = '" + studentId + "'";
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    sql = "UPDATE student_db SET " + column + " = '" + newValue + "' WHERE student_id = '" + studentId + "'";
